import 'package:delivery_boy/models/home/billing_address.dart';
...
class BillingInfo {
  ...
  String get fullAddress => '$address, $city, $state, $zip, $country';

  bool get canOpenMap => lat != null && lng != null;

  LatLng? get latLng =>
      canOpenMap ? LatLng(double.parse(lat!), double.parse(lng!)) : null;
